...
public class ProcessPanel extends MyGridPanel{
    ...
    public ProcessPanel(ActionListener actionListener, String processName, boolean communicate){
        setBackground(Color.decode("#FDFEFE"));
        initComponents(actionListener, processName, communicate);
        setBorder(BorderFactory.createLineBorder(Color.BLACK, 1, true));
    }

    private void initComponents(ActionListener actionListener, String processName, boolean communicate){
        ...
        initButtons(actionListener,processName, communicate);
    }

    private void initButtons(ActionListener listener, String name, boolean communicate){
        ...
        communicateProcessBtn.setEnabled(communicate);
